...
static const _GenerateHeatmap_Request_type_support_symbol_names_t _GenerateHeatmap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_control_services, srv, GenerateHeatmap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_control_services, srv, GenerateHeatmap_Request)),
  }
};
...
{
  return &::turtlebot3_control_services::srv::rosidl_typesupport_cpp::GenerateHeatmap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_control_services, srv, GenerateHeatmap_Request)() {
  return get_message_type_support_handle<turtlebot3_control_services::srv::GenerateHeatmap_Request>();
}
...
static const _GenerateHeatmap_Response_type_support_symbol_names_t _GenerateHeatmap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_control_services, srv, GenerateHeatmap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_control_services, srv, GenerateHeatmap_Response)),
  }
};
...
{
  return &::turtlebot3_control_services::srv::rosidl_typesupport_cpp::GenerateHeatmap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot3_control_services, srv, GenerateHeatmap_Response)() {
  return get_message_type_support_handle<turtlebot3_control_services::srv::GenerateHeatmap_Response>();
}
...
static const _GenerateHeatmap_type_support_symbol_names_t _GenerateHeatmap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot3_control_services, srv, GenerateHeatmap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot3_control_services, srv, GenerateHeatmap)),
  }
};
...
{
  return &::turtlebot3_control_services::srv::rosidl_typesupport_cpp::GenerateHeatmap_service_type_support_handle;
}
