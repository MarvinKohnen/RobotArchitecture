...
static const _PriorityTwist_type_support_symbol_names_t _PriorityTwist_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, PriorityTwist)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, PriorityTwist)),
  }
};
...
{
  return &::custom_msgs::msg::rosidl_typesupport_cpp::PriorityTwist_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_msgs, msg, PriorityTwist)() {
  return get_message_type_support_handle<custom_msgs::msg::PriorityTwist>();
}
