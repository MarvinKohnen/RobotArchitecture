...
class Updater:
    ...
    def __init__(self) -> None:
        ...
        self.last_movement = np.array((0,0))
        self.last_position = np.array((-10,0))
    ...
    def _get_controll_commands(self, current_point, current_orientation):
        ...
        pot_force_vektor = potential_force(current_point, GOAL, self.last_movement, OBSTACLES)           # <----------------------------
        ...
        self.last_movement = pot_force_vektor
    ...
    def _get_controll_commands_with_adjustment(self, current_point, current_orientation):
        ...
        # pot_force_vektor = potential_force(current_point, GOAL, self.last_movement, OBSTACLES)           # <----------------------------
        pot_force_vektor = potential_force(current_point, GOAL, current_point-self.last_position, OBSTACLES)           # <----------------------------
        ...
        self.last_position = current_point.copy()
        #############
